...
switch algorithm
    ...
    case "PDIS_LS"
        [KKT] = KKT_PDIS_LS(decision_variables,f_0,f_i,equality,parameters,option);
    otherwise
        error("algorithm must be one of the following:'barrier_LS', 'PDIS','AL_LS', 'PD_standard_LS', 'primal_dual','slack_barrier', 'barrier', or 'slack_barrier'. Type (help IPsolver) for more details")
end
