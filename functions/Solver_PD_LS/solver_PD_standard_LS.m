function [pd_solver] = solver_PD_standard_LS(KKT,x_start,parameters_subs,warm_start);
tic
...
grad_L_func             = KKT.grad_L_func              ;% symbolic varibales for the  cost function
    ...
    switch 1
        ...
        case 2
            ...
            stop = norm(r_daul) <epsilon_feas &&...
                norm(r_pri)  <epsilon_feas &&... % equality
